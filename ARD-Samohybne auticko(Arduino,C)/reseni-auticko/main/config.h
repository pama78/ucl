...
#define SERVO_LEFT_MIN  45
#define SERVO_RIGHT_MIN 135 
...
#define INTERVAL_MOTOR 150 // interval for multitasking
#define INTERVAL_SERVO 30 // interval for multitasking
